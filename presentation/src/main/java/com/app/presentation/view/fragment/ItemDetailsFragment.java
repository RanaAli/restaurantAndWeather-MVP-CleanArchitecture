...
public class ItemDetailsFragment extends BaseFragment implements ItemDetailsView {
  ...
  @Inject ItemsDetailsPresenter itemsDetailsPresenter;
  ...
  @Bind(R.id.tv_oldPrice) TextView tv_oldPrice;
  @Bind(R.id.tv_idValue) TextView tv_idValue;
  @Bind(R.id.tv_id) TextView tv_id;
  @Bind(R.id.rg_layout) RadioGroup radioGroup;
  @Bind(R.id.imageViewPager) ViewPager viewPager;
  @Bind(R.id.quantity_ll) LinearLayout quantityLl;
  ...
  @Override public void disableRadioButton(int position) {
    SizeButton sizeButton = sizeButtonList.get(position);
    sizeButton.setEnabled(false);
  }

  @Override public void enableRadioButton(int position) {
    SizeButton sizeButton = sizeButtonList.get(position);
    sizeButton.setEnabled(true);
  }

  @Override public void setProductID(String id) {
  ...
  @Override public void setMaxQuantity(int max) {
