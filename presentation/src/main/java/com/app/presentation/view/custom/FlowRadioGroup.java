...
/**
 * Code taken from https://github.com/ApmeM/android-flowlayout
 * and modified.
 */
public class FlowRadioGroup extends RadioGroup {
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      child.measure(
          getChildMeasureSpec(widthMeasureSpec, this.getPaddingLeft() + this.getPaddingRight(),
              lp.width),
          getChildMeasureSpec(heightMeasureSpec, this.getPaddingTop() + this.getPaddingBottom(),
              lp.height));
  ...
  private void drawDebugInfo(Canvas canvas, View child) {
    ...
    if (lp.horizontalSpacing > 0) {
      ...
      canvas.drawLine(x + this.horizontalSpacing - 4.0f, y - 4.0f, x + this.horizontalSpacing, y,
          layoutPaint);
      canvas.drawLine(x + this.horizontalSpacing - 4.0f, y + 4.0f, x + this.horizontalSpacing, y,
          layoutPaint);
    }
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
      ...
      try {
        ...
        verticalSpacing = NO_SPACING;
            //a.getDimensionPixelSize(R.styleable.FlowLayout_LayoutParams_layout_verticalSpacing,
            //    NO_SPACING);
