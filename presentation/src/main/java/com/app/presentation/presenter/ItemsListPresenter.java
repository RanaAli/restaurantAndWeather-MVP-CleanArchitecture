 ...
 * layer.
 */
@PerActivity public class ItemsListPresenter implements Presenter {
  ...
  @Inject
  public ItemsListPresenter(SearchItem searchItem, ItemsModelDataMapper itemsModelDataMapper) {
  ...
  private void getItemsList() {
    this.searchItem.execute(new ItemsListObserver(),
        SearchItem.Params.forQuery("boy", page.toString(), "1"));
  }
  ...
  private final class ItemsListObserver extends DefaultObserver<SearchResult> {
